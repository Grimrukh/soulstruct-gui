...
from soulstruct.gui.base.editors.base_editor import BaseEditor, EntryRow
from soulstruct.gui.base.utilities import bind_events
...
class EnumsEditor(BaseEditor):
    ...
    def _update_names_from_import(self, entity_module: str | Path | types.ModuleType, module_path: Path):
