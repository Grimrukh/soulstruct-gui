...
from soulstruct.base.game_types import GameObjectInt, GameObjectIntSequence, BaseParam
from soulstruct.exceptions import InvalidFieldValueError
from soulstruct.utilities.text import camel_case_to_spaces

from soulstruct.gui.base.editors.base_editor import BaseEditor
from soulstruct.gui.base.links import WindowLinker
from soulstruct.gui.base.utilities import bind_events, NumberEditBox
from soulstruct.gui.window import ToolTip

if tp.TYPE_CHECKING:
    from soulstruct.gui.base.core import GameDirectoryProject
    from soulstruct.gui.base.links import BaseLink
    from soulstruct.gui.typing import *
    from soulstruct.gui.window import SmartMenu

_LOGGER = logging.getLogger(__name__)


FIELD_TYPE_TYPING = tp.Union[type[GameObjectInt], type[GameObjectIntSequence], type, tp.Iterable]
...
class FieldRow:
    ...
    def __init__(self, editor: BaseFieldEditor, row_index: int, main_bindings: dict = None):
        ...
        self.field_name = ""
        self.field_type = type  # type: FIELD_TYPE_TYPING
        self.field_nickname = ""
