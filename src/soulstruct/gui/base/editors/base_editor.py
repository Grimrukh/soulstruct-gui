...
from soulstruct.gui.base import editor_config
...
from soulstruct.gui.window import SmartFrame, ToolTip
...
class BaseEditor(SmartFrame, abc.ABC):
    ...
    def select_category(
        self, selected_category: str | None, first_display_index=0, auto_scroll=False, view_change=False
    ):
    ...
    def get_remembered_id(self, category) -> int | None:
