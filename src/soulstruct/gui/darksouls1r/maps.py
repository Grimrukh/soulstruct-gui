...
from soulstruct.gui.base.editors.maps import MapsEditor as BaseMapsEditor
from soulstruct.gui.darksouls1ptde.maps import ConnectCollisionCreator, MapEntryRow
