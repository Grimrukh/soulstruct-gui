...
from soulstruct.darksouls1r.maps import MapStudioDirectory, EnumModuleGenerator
    ...
    def write_enums_modules_with_bundled_vanilla(self, map_studio_directory: MapStudioDirectory):
        ...
        for map_stem, msb in map_studio_directory.files.items():
            ...
            try:
                ...
                vanilla_module = ""
            EnumModuleGenerator(msb, game_map.msb_file_stem).write_enums_module(
    ...
    def import_Enums(
        ...
        if use_bundled_vanilla_enums:
            ...
            for map_stem, msb in maps.files.items():
                ...
                EnumModuleGenerator(msb, game_map.msb_file_stem).write_enums_module(
                    enums_folder / f"{game_map.emevd_file_stem}_enums.py",
                )
